  ...
  [9340],
  {
    ...
    39340: function (e, t, i) {
      ...
      var n = function () {
          ...
          return t(
            "el-row",
            { staticClass: "layout has-sidebar" },
            [
              t(
                "el-col",
                { attrs: { span: 18 } },
                      ...
                      t(
                        ...
                        [
                          t(
                            ...
                            e._l(e.device.profiles, function (i, n) {
                              return t(
                                "el-radio-button",
                                {
                                  key: n,
                                ...
                                [
                                  1 == i.ModeIndex
                                    ? t("span", [
                                        e._v(e._s(e.$t("common.layer_std"))),
                                      ])
                                    : e._e(),
                                  2 == i.ModeIndex ||
                                  3 == i.ModeIndex ||
                      ...
                      [
                        t(
                          ...
                          [
                            t(
                              "el-tab-pane",
                              { attrs: { label: e.$t("le.le_setting_title") } },
                              [
                                t("cms-lelist", {
                                  ref: "lelist",
                                  attrs: {
                            ...
                            t(
                              ...
                              {
                                attrs: {
                                  label: e.$t("macro.macro_setting_title"),
                                },
                              },
                              [
                                t("cms-macrolist", {
                                  ref: "macrolist",
                                  attrs: { macrolist: e.cms.macros },
        ...
        o = [],
        s = (i(25276), i(26099), i(16034), i(38781), i(23500), i(38378)),
        a = i(24988),
        r = i(22606),
        l = i(7201),
        c = i(10088),
        ...
        y = document.getElementById("mainbox").offsetWidth;
      window.KeyFunc = u();
      var h = {
          data() {
            return {
          ...
          mounted() {
            ...
            (window.onresize = function () {
              ...
              (e.$refs.device.isshowkeyset = e.isshowkeyset),
          ...
          methods: {
            ...
            changeKeyFunc: function (e, t) {
              ...
              if (
                ...
                var s = window.KeyFunc[t].DriverValue.split(",");
                if ("disable_all" == t) {
                  s = [];
                  for (o = 0; o < n.length; o++) s.push(n[o].Index.toString());
                }
                for (o = 0; o < n.length; o++)
                  if (s.indexOf(n[o].Index.toString()) >= 0) {
                    (n[o].MenuName = window.KeyFunc["0x02000000"].Name),
                      (n[o].DriverValue =
                        window.KeyFunc["0x02000000"].DriverValue);
                    var a = document.getElementById("key" + n[o].Index);
                    a &&
                      ((a.innerHTML = "<span class='hasfunc'></span>"),
                ...
                var r = document.getElementById("key" + DEVICE.editKeyCode);
                r &&
                  (window.KeyFunc[t]
                    ? ((r.innerHTML =
                        "<span class='hasfunc'>" +
                      ...
                      window.KeyFunc[t].Icon &&
                        (r.children[0].classList.add(window.KeyFunc[t].Icon),
                        (r.children[0].innerHTML = "")),
                      window.KeyFunc[t].ShowClass &&
                        r.children[0].classList.add(
                          window.KeyFunc[t].ShowClass,
                        ))
                    : (e.length <= 5
                        ? (r.innerHTML =
                            "<span class='hasfunc'>" + e + "</span>")
                        : (r.innerHTML =
                            "<span class='hasfunc'>" +
                            e.substring(0, 4) +
                            "...</span>"),
                      r.setAttribute("data-func", e)),
                  r.classList.add("seted"));
                for (o = 0; o < n.length; o++)
            ...
            setKeyMacro: function (e, t) {
              ...
              if (
                ...
                for (var s = 0; s < n.length; s++)
                  n[s].Index === DEVICE.editKeyCode &&
                    ((n[s].MenuPID = 1),
                    (n[s].MenuName = e),
                    (n[s].DriverValue = "0x0A010001"),
                    (n[s].Task = { Type: "Macro", Data: {} }),
                    (n[s].Task.Data = t),
                    window.isKeySetChange()
                      ? (i.iskeysetchange = !0)
                      : (i.iskeysetchange = !1));
            ...
            handleKeyLeConfirm: function () {
              ...
              if (1 == DEVICE.currentProfile.ModeIndex)
                ...
                (document.getElementById("config_le").innerHTML =
                  DEVICE.keylesel.Name),
                  e.changeKeyLE(t, DEVICE.keylesel.Name, DEVICE.keylesel.GUID);
              }
              e.dialogkeylesel.visible = !1;
            },
            playLE() {
            ...
            renderStaticLE: function () {
              ...
              (DEVICE.currentProfile.ModeLE.GUID = ""),
                (DEVICE.currentProfile.ModeLE.Name = e.$t("le.diy_static_le")),
        ...
        p = h,
        g = (i(93056), i(14486)),
        E = (0, g.A)(p, n, o, !1, null, "25c93491", null),
        v = E.exports;
    },
    43893: function (e, t, i) {
      "use strict";
      i.r(t),
        i.d(t, {
          default: function () {
      ...
      var n = function () {
        ...
        o = [],
        s = (i(2008), i(25276), i(26099), i(8779)),
        a = {
          data() {
            return {
              loading: !0,
        ...
        r = a,
        l = (i(20314), i(14486)),
        c = (0, l.A)(r, n, o, !1, null, "4c887e01", null),
        d = c.exports;
    },
    93056: function (e, t, i) {
      var n = i(24119);
