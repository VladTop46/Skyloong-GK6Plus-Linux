  ...
  [6285, 7924, 4624, 1315],
  {
    ...
    1315: function (e, t, i) {
      ...
      function n() {
        ...
        function d(e) {
          0 === e.touches.length && y();
        }
        function h(e) {
          1 === e.touches.length &&
            g(e.touches[0].clientX, e.touches[0].clientY);
        }
        function u(e) {
          n || p(e.clientX, e.clientY);
        }
        function m(e) {
          n || y();
        }
        function f(e) {
          n || (0 === e.button && g(e.clientX, e.clientY));
        }
        function p(e, t) {
          (a = e), (l = t), (r = 0);
        }
        function y() {
          ...
          r < 10 &&
            (n - s < 300 ? (o += 1) : (o = 1),
            (s = Date.now()),
            i(e, { clientX: a, clientY: l }),
            2 === o && (i(t, { clientX: a, clientY: l }), (o = 0))),
            (r = 0);
        }
        function g(e, t) {
          var i = a - e,
    ...
    97924: function (e, t, i) {
      ...
      var n = function () {
          ...
          return t(
            "div",
            {
              ...
              on: {
                ...
                DOMMouseScroll: e.onMouseWheel,
                mousedown: e.onMouseDown,
                mouseup: e.onMouseUp,
                mousemove: e.onMouseMove,
                mouseout: e.setPointerPosCenter,
            ...
            [
              t(
                "div",
                { staticClass: "zoomer", style: e.wrapperStyle },
                [e._t("default")],
                2,
              ),
            ],
        ...
        a = {
          ...
          computed: {
            wrapperStyle() {
              var e = this.containerWidth * this.animTranslateX,
                t = this.containerHeight * this.animTranslateY;
              return {
                transform: [
                  `translate(${e}px, ${t}px)`,
          ...
          mounted() {
            (this.tapDetector = new r["default"]()),
          ...
          methods: {
            getImageSize() {
              ...
              if (this.src) {
                var t = new Image();
                (t.src = this.src),
                  (t.naturalWidth = this.imageWidth),
                  (t.naturalHeight = this.imageHeight);
                var i = function i() {
                  e.$emit("error"), t.removeEventListener("error", i);
                };
                t.addEventListener("error", i);
                var n = function i() {
                  (e.imageSize = { width: t.width, height: t.height }),
                    e.imageSize,
                    e.$emit("success"),
            ...
            tryToScale(e) {
              ...
              if (this.zoomingElastic) {
                if (t < this.minScale || t > this.maxScale) {
                  var i = Math.log2(e);
                  (i *= 0.2), (e = Math.pow(2, i)), (t = this.scale * e);
                }
              } else
                t < this.minScale
                  ? (t = this.minScale)
              ...
              if (
                ...
                (this.translateX = (0.5 + this.translateX - n) * e + n - 0.5),
                  (this.translateY = (0.5 + this.translateY - s) * e + s - 0.5);
              }
            },
            setPointerPosCenter() {
            ...
            onPointerMove(e, t) {
              if (this.isPointerDown) {
                var i = e - this.pointerPosX,
                  n = t - this.pointerPosY;
                this.panLocked ||
            ...
            limit() {
              if (
                ...
                var e = this.calcTranslateLimit();
                Math.abs(this.translateX) > e.x &&
                  (this.translateX *= e.x / Math.abs(this.translateX)),
                  Math.abs(this.translateY) > e.y &&
                    (this.translateY *= e.y / Math.abs(this.translateY));
              }
            },
            calcTranslateLimit() {
              if ("y" === this.getMarginDirection()) {
                var e =
                    ...
                    this.containerHeight,
                  t = (this.scale * e - 1) / 2;
                return t < 0 && (t = 0), { x: (this.scale - 1) / 2, y: t };
              }
              var i =
            ...
            getMarginDirection() {
              var e = this.containerWidth / this.containerHeight;
              return e > this.aspectRatio ? "x" : "y";
            },
            onDoubleTap(e) {
              1 === this.scale
                ? (e.clientX > 0 &&
            ...
            onWindowResize() {
              ...
              (this.containerWidth = parseFloat(e.width)),
                (this.containerHeight = parseFloat(e.height)),
                this.setPointerPosCenter(),
                this.limit();
            },
            refreshContainerPos() {
              var e = this.$el.getBoundingClientRect();
              (this.containerLeft = e.left), (this.containerTop = e.top);
            },
            loop() {
            ...
            gainOn(e, t) {
              var i = 0.3 * (t - e);
              return Math.abs(i) > 1e-5 ? e + i : t;
            },
            onMouseWheel(e) {
              if (this.mouseWheelToZoom) {
                e.preventDefault(), e.detail && (e.wheelDelta = -10 * e.detail);
                var t = Date.now();
                120 === Math.abs(e.wheelDelta)
                  ? t - this.lastFullWheelTime > 50 &&
                    (this.onMouseWheelDo(e.wheelDelta),
                    (this.lastFullWheelTime = t))
                  : (t - this.lastWheelTime > 50 &&
                      "number" === typeof e.deltaX &&
                      ((this.lastWheelDirection =
                        0 == e.detail && Math.abs(e.deltaX) > Math.abs(e.deltaY)
                          ? "x"
                          : "y"),
                      "x" === this.lastWheelDirection &&
                        this.$emit("swipe", e.deltaX > 0 ? "left" : "right")),
            ...
            onTouchStart(e) {
              if (1 === e.touches.length)
                this.refreshContainerPos(),
                  (this.pointerPosX = e.touches[0].clientX),
                  (this.pointerPosY = e.touches[0].clientY),
                  (this.isPointerDown = !0);
                ...
                this.twoFingerInitDist = Math.sqrt(t * t + i * i);
              }
            },
            onTouchEnd(e) {
              0 === e.touches.length
            ...
            onTouchMove(e) {
              if (1 === e.touches.length)
                ...
                var t = (e.touches[0].clientX + e.touches[1].clientX) / 2,
                  i = (e.touches[0].clientY + e.touches[1].clientY) / 2;
                this.onPointerMove(t, i),
                  (this.pointerPosX = t),
                  (this.pointerPosY = i);
                var n = e.touches[0].clientX - e.touches[1].clientX,
        ...
        l = a,
        c = (i(39135), i(14486)),
        d = (0, c.A)(l, n, s, !1, null, "43d84498", null),
        h = d.exports;
    },
    66285: function (e, t, i) {
      "use strict";
      i.r(t),
        i.d(t, {
          default: function () {
      ...
      var n = function () {
          ...
          return t(
            ...
            [
              t("img", {
                staticClass: "device-panel no-max-width",
                style: {
              ...
              t("img", {
                staticClass: "device-keycap no-max-width",
                style: {
                  width: 1200 * e.scale + "px",
                  height: 600 * e.scale + "px",
                  left: -e.offsetleft + "px",
              ...
              t("img", {
                staticClass: "device-outline no-max-width",
                style: {
                  width: 1200 * e.scale + "px",
                  height: 600 * e.scale + "px",
                  left: -e.offsetleft + "px",
              ...
              e._l(e.showkeymap, function (e, i) {
                return t("div", {
                  key: i,
              ...
              e._l(e.showkeymap, function (i, n) {
                return t("div", {
                  directives: [
                    {
                      name: "show",
              ...
              t(
                ...
                e._l(e.showkeymap, function (i, n) {
                  return t("div", {
                    ...
                    refInFor: !0,
                    staticClass:
                      "device-key xs:text-xx-small sm:text-xx-small md:text-xx-small lg:text-x-small xl:text-smaller 2xl:text-smaller 3xl:text-smaller",
                    ...
                    attrs: {
                      "data-logic": i.LogicCode,
                      id: "key" + i.LogicCode,
                    },
                    on: {
                      click: function (t) {
                        return e.handleKeyClick(i.LogicCode);
                      },
                      mouseover: function (t) {
                        return e.showConfig(i.LogicCode);
                      },
                      dblclick: function (t) {
                        return e.togglehandle(i);
                      },
                    },
                  });
                }),
              ...
              e.showstdset
                ? t(
                    ...
                    {
                      staticClass:
                        "custom el-tooltip__popper is-dark xs:text-xs sm:text-sm md:text-md lg:text-lg xl:text-xl 2xl:text-2xl 3xl:text-3xl",
                      staticStyle: { padding: "6px" },
                      attrs: { id: "std_conf_showbox" },
                    },
                    [
                      t("div", [
                        t("table", { staticClass: "key-func flex flex-col" }, [
                          t(
                            "tr",
                            {
                              staticClass: "flex",
                                    ...
                                    [
                                      ...
                                      t(
                                        ...
                                        [
                                          ...
                                          t("i", {
                                            staticClass:
                                              "el-icon-s-tools warning",
                                            on: {
                                              click: function (t) {
                                                return e.handleSelectStdLE(n);
                                              },
                                            },
                                          }),
                                        ],
                      ...
                      t(
                        ...
                        [
                          t(
                            ...
                            { attrs: { span: 24 } },
                            [
                              e._l(e.quickselects, function (i, n) {
                                return t(
                                  "el-button",
                                  {
                                    key: n,
                                    ...
                                    on: {
                                      click: function (t) {
                                        return e.selectQuickKeys(i.lcodes);
                                      },
                                    },
                                    nativeOn: {
        ...
        s = [],
        o = (i(25276), i(26099), i(38781), i(23500), i(97924)),
        r = i(94624),
        a = document.getElementById("mainbox").offsetHeight,
        l = document.getElementById("mainbox").offsetWidth,
        c = {
          data() {
            return {
              mainh: a,
          ...
          components: { DeviceImage: o["default"], ImageWrapper: r["default"] },
          computed: {
            showkeymap: function () {
              var e = this.scale,
                t = [];
              (this.offsetleft = (this.scaleplus / 2) * 1200),
                (this.offsettop = (this.scaleplus / 2) * 600);
              for (var i = 0; i < this.keymap.length; i++) {
                var n = JSON.parse(JSON.stringify(this.keymap[i]));
                (n.Position.Top =
                  this.keymap[i].Position.Top * e - this.offsettop),
                  (n.Position.Left =
                    this.keymap[i].Position.Left * e - this.offsetleft),
                  (n.Position.Width = this.keymap[i].Position.Width * e),
                  (n.Position.Height = this.keymap[i].Position.Height * e),
                  t.push(n);
              }
              return t;
            },
          ...
          watch: {
            ...
            "device.currentProfile.ModeIndex": function (e, t) {
              return 656801992 === window.CMS.deviceID ||
                656802033 === window.CMS.deviceID ||
                656802036 === window.CMS.deviceID
                ? (this.showstdset = !1)
                : void (1 === e ? this.showStdSet() : this.hideStdSet());
            },
            mutiselectkeys(e) {
          ...
          methods: {
                ...
                this.$nextTick(function () {
                  e.showStdBtns(),
                    ...
                    window.readLE(
                      ...
                      function (t) {
                        t && ((window.LeData = t), window.LeData, e.playLe());
                      },
                    ),
                    document
              ...
              e.isfnkeyset
                ? ((t = "FnKeySet"),
                  ...
                  DEVICE.currentProfile.KeySet.forEach(function (e, t) {
                    ...
                    i &&
                      (i.classList.remove("seted"),
                      i.classList.remove("fnseted"),
                      i.classList.remove("key-breath"),
                      i.setAttribute("data-func", ""),
                      i.setAttribute("data-le", ""),
                      (i.innerHTML = "<span></span>"));
                  }))
                : (e.isfnlayer = !1),
                DEVICE.currentProfile[t].forEach(function (i, n) {
                  var s = document.getElementById("key" + i.Index);
                  if (s) {
                    if (
                      (s.classList.remove("seted"),
                      s.classList.remove("fnseted"),
                      s.setAttribute("data-func", ""),
                      s.setAttribute("data-le", ""),
                      (s.innerHTML = "<span></span>"),
                      e.isfnkeyset && s.classList.add("fnseted"),
                      DEVICE.currentProfile[t][n].MenuName)
                    )
                      if (
                        (s.children[0].classList.add("hasfunc"),
                        s.classList.add("seted"),
                        "0x0A010001" == DEVICE.currentProfile[t][n].DriverValue)
                      )
                        (s.children[0].innerHTML = i.MenuName),
                          s.setAttribute("data-func", i.MenuName);
                      else if ((i.DriverValue, window.KeyFunc[i.DriverValue]))
                        window.KeyFunc[i.DriverValue].hasOwnProperty("Icon") &&
                          s.children[0].classList.add(
                            window.KeyFunc[i.DriverValue].Icon,
                          ),
                          window.KeyFunc[i.DriverValue].ShowClass &&
                            s.children[0].classList.add(
                              window.KeyFunc[i.DriverValue].ShowClass,
                            ),
                          s.setAttribute(
                            "data-func",
                            e.$t("keys")[
                              window.KeyFunc[i.DriverValue].LangTitle
                            ],
                          ),
                          window.KeyFunc[i.DriverValue].Icon
                        ...
                        (s.setAttribute("data-func", i.MenuName),
                        i.MenuName.length > 2 && i.MenuName.length <= 5)
                      )
                        i.MenuName, (s.children[0].innerHTML = i.MenuName);
                      else {
                        s.children[0].innerHTML, i.MenuName;
                        var o = s.offsetWidth,
                          r = s.offsetHeight,
                          a = 0.3 * Math.min(o, r) + "px";
                        (s.querySelector("span").style.fontSize = a),
                          (s.children[0].innerHTML =
                            i.MenuName.substring(0, 4) + "...");
                      }
                    DEVICE.currentProfile.KeySet[n].KeyLE &&
                      "" !== DEVICE.currentProfile.KeySet[n].KeyLE.GUID &&
                      (s.classList.add("seted"),
                      s.setAttribute(
                        "data-le",
                        DEVICE.currentProfile.KeySet[n].KeyLE.Name,
                      ));
                  }
                });
            },
            ...
            showStdBtns: function () {
              ...
              var t = document.getElementById("std_conf_showbox"),
                i = CMS.deviceConfig.DriverLEKey,
                n = document.getElementById("key" + i);
              n.offsetWidth,
                n.offsetLeft,
                n.offsetTop,
                t.offsetWidth,
              ...
              t.style.setProperty("left", "1rem", "important"),
                t.style.setProperty("bottom", "2.25rem", "important");
            },
            showConfig(e) {
              ...
              if (
                ...
                var i = document.getElementById(`key${e}`),
                  n = { KeyFUNC: "", KeyLE: "" };
                (n.KeyFUNC = i.getAttribute("data-func")),
                  (n.KeyLE = i.getAttribute("data-le")),
                  (document.getElementById("config_key").innerText = n.KeyFUNC
                    ? n.KeyFUNC
                    : this.$t("common.key_func_no_config")),
                  document.getElementById("config_le") &&
                    (document.getElementById("config_le").innerText = n.KeyLE
                      ? n.KeyLE
            ...
            handleKeyClick: function (e) {
              ...
              if (1 != DEVICE.currentProfile.ModeIndex)
                if (0 !== e) {
                  ...
                  t.isfnkeyset && (n = DEVICE.currentProfile.FnKeySet);
                  ...
                  if (i) {
                    ...
                    var o = document.getElementById("key" + e);
                    o.classList.add("key-breath"),
                      window.removeClass(window.siblings(o), "key-breath");
                  } else
                    t.alertInfo(
            ...
            renderFrame: function (e) {
              ...
              for (var n in e) {
                var s = document.getElementById("le" + n);
                s && s.style.setProperty("background", window.toJS(e[n]));
              }
            },
            togglehandle(e) {},
            playLe() {
              var e = this,
                ...
                s = 0;
              if (LeData.Canvases)
                for (var o = 0; o < LeData.Canvases.length; o++)
                  if (
                    LeData.Canvases[o].DeviceTypes.indexOf(
                      CMS.deviceConfig.DeviceType.toString(),
                    ) >= 0
                  ) {
                    LeData = JSON.parse(JSON.stringify(LeData.Canvases[o]));
                    break;
                  }
              JSON.stringify(LeData);
              for (var r = 0; r < LeData.Frames.length; r++)
                s += LeData.Frames[r].Count;
              DEVICE.timer &&
              ...
              DEVICE.timer = setInterval(function () {
                n++, n == s && (n = 0);
                for (
                  var o = JSON.parse(JSON.stringify(LeData.LEConfigs)),
                    r = {},
                    l = 0;
                  l < o.length;
                  l++
                  ...
                  switch (
                    (o[l].Color || (o[l].Color = "0xffffff"), o[l].Type)
                  ) {
                    case 0:
                      o[l].Color = window.toJS(o[l].Color);
                      break;
                    case 1:
                      var c = window.toHSB(o[l].Color);
                      (c.h =
                        (c.h + (a % o[l].Count) * (360 / o[l].Count)) % 360),
                        (o[l].Color = window.fromRGB(window.fromHSB(c)));
                      break;
                    case 2:
                      c = window.toHSB(o[l].Color);
                      (c.b =
                        c.b -
                        ((a % (o[l].Count + o[l].StayCount)) /
                          (o[l].Count + o[l].StayCount)) *
                          100),
                        (o[l].Color = window.fromRGB(window.fromHSB(c)));
                      break;
                  }
                  for (var d in o[l].Keys) r[o[l].Keys[d]] = o[l].Color;
                }
                var h = {};
                for (var u in LeData.Frames[t].Data)
                  r[u] ? (h[u] = r[u]) : (h[u] = "0xffffff");
                LeData.Frames[t].Count > 1
                  ? (i == LeData.Frames[t].Count - 1 &&
                      (t++, (i = 0), t == LeData.Frames.length && (t = 0)),
                    e.renderFrame(h),
                    i++)
                  : (LeData.Frames[t].Data && e.renderFrame(h),
                    t++,
                ...
                (t.mutiselect.startpos.x = e.pageX),
                  ...
                  (document.onmouseup = function () {
                    if (t.mutiselect.ismousedown) {
                      ...
                      for (var e = [], n = 0; n < t.keymap.length; n++) {
                        var s = document.getElementById(
                          "le" + t.keymap[n].LocationCode,
                        );
                        s && (t.mutiselect.width > 0 || t.mutiselect.height > 0)
                          ? s.offsetLeft <
                              Math.max(
                                t.mutiselect.startpos.x,
                            ...
                            e.push(t.keymap[n].LocationCode)
                          : (0 != t.mutiselect.width &&
                              0 != t.mutiselect.height) ||
                            (t.mutiselect.startpos.x >= s.offsetLeft &&
                              t.mutiselect.startpos.x <=
                                s.offsetLeft + s.offsetWidth &&
                              t.mutiselect.startpos.y - i >= s.offsetTop &&
                              t.mutiselect.startpos.y - i <=
                                s.offsetTop + s.offsetHeight &&
                              e.push(t.keymap[n].LocationCode));
                      }
        ...
        d = c,
        h = (i(98591), i(14486)),
        u = (0, h.A)(d, n, s, !1, null, null, null),
        m = u.exports;
    },
    94624: function (e, t, i) {
      "use strict";
      i.r(t),
        i.d(t, {
          default: function () {
          ...
          methods: {
            ...
            handleMouseMove(e) {
              if (this.isDragging) {
                ...
                (this.currentX += t), (this.startX = e.clientX);
              }
            },
            handleMouseUp() {
              this.isDragging = !1;
